...
var loveMsg = ["I love this song! Makes me want to jizz in my pants.", "I love this song like a black man loves chicken!", "This... song... is... DENCH!!", "Absolute fucking classic!", "TUUUUNE!!", "THIS IS JUST AWESOME BRAH!!!!", "I loves me some of dis musique!!", ];
...
var workMsg = ["Going to do some work, mention if needed!", "I'm working, cough cough", "I'm gonna be busy, do not disturb!"];
var afkMsg = ["going to chase Dinasours, brb!", "I'm going for a fap, be back soon! (jk)", "Going to hunt the galaxy, be back soon!", "Going to go report Dafuq League!", "Gonna' go download some more RAM!"];
...
var autoAwayMsg = ["gone to chase dinasaurs, brb!", "stepped out for a moment", "gone away", "left the keyboard", "gone hunting", "I'm currently AFK", "Selling weed, brb. (afk)", "left, be back soon!", "Not present at keyboard."];
var autoSlpMsg = ["I'm currently sleeping", "shhhh I'm sleeping!", "I'm sleeping, don't disturb!! D:", "I've hit the sack", "I'm asleep in bed"];
var autoWrkMsg = ["I'm currently working", "I'm busy", "I'm pretending to work, but really I'm just ignoring you...", "Trying to earn a dollar, your mum charges high rates! (just kidding)"];
...
delay();
$('#plugbot-js').remove();
log("Coded by Nitro Ghost. Version: 4.1.4");
