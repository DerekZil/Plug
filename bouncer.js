...
var enMsg = ["English only in chat!", "Speak English or you will be kicked!", "This is an English speaking room only!"];
...
delay();
$('#plugbot-js').remove();
log("Also, welcome to ★Insanity Realms★, coded by Nitro Ghost. Version: 4.1.4");
